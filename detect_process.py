...
from lane_process import process_image
...
def process(args):
    ...
    while stream.isOpened():
        ...
        frame = process_image(frame,l_line,r_line)
        ...
        if len(objects_detected) > 0:
            ...
            cv.putText(frame, "FPS : " + str(int(fps)), (100,50), cv.FONT_HERSHEY_SIMPLEX, 0.75, (255,0,0), 2)
